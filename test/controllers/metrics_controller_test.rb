...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference("Metric.count") do
      post metrics_url, params: { metric: { global_view_count: @metric.global_view_count, month_view_count: @metric.month_view_count } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { global_view_count: @metric.global_view_count, month_view_count: @metric.month_view_count } }
